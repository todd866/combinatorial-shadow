...
Empirical evidence supports the claim that classical psychedelics (5-HT\textsubscript{2A} agonists) increase the effective dimensionality of neural dynamics.
Using MEG data from 136 sessions, Todd~\citeyearpar{todd2025lsd} found that psilocybin increases $D_{\mathrm{eff}}$ by $+15.0\%$ (Cohen's $d = 0.78$, $p = 0.003$) and LSD by $+13.4\%$ ($d = 0.50$, $p = 0.082$), while ketamine (NMDA antagonist, not a classical psychedelic) showed no significant change.
...
The empirical datum that psychedelics increase neural $D_{\mathrm{eff}}$ is not in dispute \citep{todd2025lsd,schartner2017,carhart-harris2014}.
The interpretation is the conjecture.
...
\item \textbf{Dimensional Landauer bound} \citep{todd2026landauer}: the thermodynamic cost of dimensional reduction.
The defence mechanism cost (Simulation D) is a social instantiation.
